 ...
 * @return array Files.
 */
function quail_ocdi_files() {

	return array(

		array(
			'import_file_name'             => esc_html__( 'Theme Demo', 'quail' ),
...
add_filter( 'pt-ocdi/import_files', 'quail_ocdi_files');
 ...
 * @since 1.0.0
 */
function quail_ocdi_after_import() {
...
add_action( 'pt-ocdi/after_import', 'quail_ocdi_after_import' );
